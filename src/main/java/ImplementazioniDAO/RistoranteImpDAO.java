...
public class RistoranteImpDAO implements RistoranteDAO {
     ...
     * @throws BusinessError (CANCELLAZIONE_RISTORANTE_ANNULATA_ORDINI_IN_CONSEGNA,IMPOSSIBILE_CONETTERSI_DATABASE)
     */
    @Override
